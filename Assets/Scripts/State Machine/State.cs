...
public abstract class State
{
    ...
    public virtual void OnEnter(AnimatorStateMachine animatorStateMachine)
    {
    ...
    /// <returns></returns>
    protected T GetComponent<T>() where T : Component { return AnimatorStateMachine.GetComponent<T>(); }
    ...
    /// <returns></returns>
    protected Component GetComponent(System.Type type) { return AnimatorStateMachine.GetComponent(type); }
    ...
    /// <param name="type">The type of Component to retrieve.</param>
    /// <returns></returns>
    protected Component GetComponent(string type) { return AnimatorStateMachine.GetComponent(type); }
    #endregion
}